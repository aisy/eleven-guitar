...
--
-- Host: 127.0.0.1
-- Generation Time: 04 Mar 2017 pada 10.39
...
--
-- Dumping data untuk tabel `list_owner`
--

INSERT INTO `list_owner` (`id_listown`, `nama_list`, `caption`, `id_powner`) VALUES
(9, 'Vidi', 'lorem', 3);
...
INSERT INTO `profil` (`id_profil`, `judul`, `gambar_header`, `isi_profil`) VALUES
(1, '', '0396d64af6b8a78528e9c5ffd2ae5480.png', '');
...
INSERT INTO `profil_owner` (`id_powner`, `nama_owner`, `foto`) VALUES
(2, 'imam', '84156d837aa879fbda5bbb224516584c.jpg'),
(3, 'Vidi', '9ba7609c5295232fd7add309dc1338a0.png');
...
--
ALTER TABLE `list_owner`
  MODIFY `id_listown` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `profil_owner`
  MODIFY `id_powner` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
